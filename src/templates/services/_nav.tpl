...
<nav class="tabs">
	...
	<ul class="sub">
		<li{if !$show_archived_services} class="current"{/if}>{if !$show_archived_services}{link href="!services/" label="Activités courantes" aria-current="page"}{else}{link href="!services/" label="Activités courantes"}{/if}</li>
		<li{if $show_archived_services} class="current"{/if}>{if $show_archived_services}{link href="!services/?archived=1" label="Activités archivées" aria-current="page"}{else}{link href="!services/?archived=1" label="Activités archivées"}{/if}</li>
	</ul>
	{/if}
