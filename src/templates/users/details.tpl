...
<div class="cjd-member">
	<div class="cjd-member__main">
		<section class="cjd-card cjd-member__services">
			<h2 class="cjd-card__title">Activités et cotisations</h2>
			<dl class="cotisation">
				...
				{if $session->canAccess($session::SECTION_USERS, $session::ACCESS_READ)}
					{if !empty($transactions_linked)}
						...
						<dd><a href="{$admin_uri}acc/transactions/user.php?id={$user.id}">{$transactions_linked} écritures comptables liées à ce membre</a></dd>
					{/if}
		...
		<section class="cjd-card cjd-member__profile">
			<h2 class="cjd-card__title">Informations</h2>
	...
	<aside class="cjd-member__side describe">
		<h2 class="cjd-card__title">Suivi</h2>
		<dl class="describe">
