...
<form method="post" action="">
	<fieldset>
		...
		<p class="help">Le verrouillage permet de préparer la clôture de l'exercice, en s'assurant qu'il n'est pas modifié par erreur si on travaille sur plusieurs exercices en même temps.</p>
	</fieldset>
	<p class="submit">
